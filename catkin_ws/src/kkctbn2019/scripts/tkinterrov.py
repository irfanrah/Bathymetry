...
if __name__ == '__main__':
	...
	while not rospy.is_shutdown():
		if ori is not None:
			...
			count = count + 1
			if count >= 100:
				Tkinter.Label(master=master, text="25 Celcius", fg='black',bg = 'green',bd = '3' ,font=("Helvetica", 25)).place(x = 890, y = 13)
				Tkinter.Label(master=master, text="106900 Pa", fg='black',bg = 'blue',bd = '3' , font=("Helvetica", 25)).place(x = 890, y = 123)
				Tkinter.Label(master=master, text="58 cm", fg='black',bg = 'red',bd = '3' , font=("Helvetica", 25)).place(x = 890, y = 203)
				count = 0
		master.update()
